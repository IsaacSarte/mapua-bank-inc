...
const ClientTransactions = (props) => {
    ...
    return (
        <div className="client-transactions-container">
            <div className="client-transactions-select">
                <section
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="dep-svg cl" viewBox="0 0 20 20" fill="currentColor">
